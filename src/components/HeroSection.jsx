  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center">
      <h1 className="text-center text-4xl  tracking-wide sm:text-6xl lg:text-7xl">
        ...
        <span className="bg-gradient-to-r from-orange-500 via-purple-500 to-red-800 bg-clip-text font-medium text-transparent">
          {" "}
          for developers
        </span>
      </h1>
      ...
      <div className="mb-5 flex flex-col md:items-center md:justify-center space-y-6 space-x-0 md:flex-row md:space-y-0 md:space-x-8">
        <a
          href="#"
